...
print("--- Đẩy lên 81 nhé ae không đón nữa thì dọn hàng nhé ---")
try:
    print(parse_signal("Đẩy lên 81 nhé ae không đón nữa thì dọn hàng nhé"))
except Exception as e:
    print("Error:", e)

time.sleep(20)

print("--- Tổng hợp tín hiệu kênh (23.09.2026) 1.#XAUUSD SELL LIMIT 4335 - 4336 (Đã hủy) 2.#XAUUSD BUY ... ---")
try:
    print(parse_signal("Tổng hợp tín hiệu kênh (23.09.2026) 1.#XAUUSD SELL LIMIT 4335 - 4336 (Đã hủy) 2.#XAUUSD BUY LIMIT 4282 4281"))
except Exception as e:
    print("Error:", e)
